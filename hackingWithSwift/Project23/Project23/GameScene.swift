...
class GameScene: SKScene {
    ...
    func createSlices(){
        ...
        activeSliceBG.strokeColor = UIColor(red: 1, green: 0.9, blue: 9, alpha: 1)
    ...
    func createEnemy(forceBomb: ForceBomb = .random){
        ...
        if enemyType == 0 {
            ...
            var specialPenguin = Int.random(in: 0...1)
            if specialPenguin == 0 {
        ...
        enemy.physicsBody?.angularDamping = randomAngularVelocity
